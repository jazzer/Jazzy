...
Move.prototype.send = function() {
	...
	// was okay)!
	var from = 'b_' + this.boardId + '_f' + this.from;
	var to = 'b_' + this.boardId + '_f' + this.to;
    var url = 'post/' + mqId + '/move/' + from + '/' + to + '/' + (this.promotion === undefined)?'':this.promotion + '/' + this.special;
    game.send(url);
}
